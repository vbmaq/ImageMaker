...
#
#
# from Gazeplotter import GazePlotter, Draw
#
# def throwForbidden():
...
#
#
# def save_images_test(df, savePath, pipeline,
# 					 addImageUnderlay=False,
...
#
# def test2():
# 	with open("configs/saccades_only", "r") as stream:
...
#
# 		create_label_dirs(labels, save_dir)
#
# 		save_images_test(df_train, savePath=save_train, pipeline=pipeline)
# 		save_images_test(df_val, savePath=save_val, pipeline=pipeline)
# 		save_images_test(df_test, savePath=save_test, pipeline=pipeline)
#
#
